...
import '../../db_hall/db_hall.dart';

class HallSecondLogic extends GetxController {
  ...
  aboutHallPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutHallUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """Provide you with the hall seat records"""),
      ],
      context: context,
    );
  }
